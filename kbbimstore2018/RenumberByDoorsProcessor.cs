...
{
    class RenumberByDoorsProcessor
    {
        ...
        public RenumberByDoorsProcessor(UIApplication uiapp)
        {
            this.uiapp = uiapp;
        ...
        public void init()
        {
            ...
            { 
                ...
                try
                {
                    RenumberByDoorsHandler handler = new RenumberByDoorsHandler(parametersNewValues);
